...
type Config struct {
	...
	// Valid values are `drop` and `keep`.
	// `drop` means data matching the conditions will be removed from the pipeline.
	// `keep` means only data matching the conditions will be kept in the pipeline.
